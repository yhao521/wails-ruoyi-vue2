      ...
      <el-scrollbar class="left-scrollbar">
        <el-tabs v-model="leftTabActiveName" @tab-click="leftTabHandleClick">
          <el-tab-pane name="first">
            <span slot="label" style="margin-left: 20px;"><i class="el-icon-s-grid"></i> 基础组件</span>
          ...
          <el-tab-pane name="second">
            <span slot="label"><i class="el-icon-more-outline"></i> 复合组件</span>
...
import {
  inputComponents, selectComponents, layoutComponents, formConf, layout1Components
...
export default {
  ...
  methods: {
    ...
    rightPanelSwitchHandle(val) {
      ...
      if (!val) {
        document.getElementsByClassName('center-board')[0].style.cssText = "margin: 0 5px 0 260px;"
      } else {
        document.getElementsByClassName('center-board')[0].style.cssText = "margin: 0 350px 0 260px;"
      }
    },
